...
USAGE = """
fermiqcd.py is a tool to help you download and use fermiqcd from

    http://code.google.com/p/fermiqcd

When you run:
 
    python fermiqcd.py [args]
...
Some [args] are handled by fermiqcd.py:
...
More examples:
    fermiqcd.py -gauge:start=cold:nt=16:nx=4
    fermiqcd.py -gauge:start=hot:nt=16:nx=4
    fermiqcd.py -gauge:load=cold.mdp
    fermiqcd.py -gauge:load=cold.mdp:steps=10:beta=5.7
    fermiqcd.py -gauge:load=*.mdp -plaquette
    fermiqcd.py -gauge:load=*.mdp -plaquette-vtk
    fermiqcd.py -gauge:load=*.mdp -polyaov-vtk
    fermiqcd.py -gauge:load=*.mdp -cool:steps=20 topcharge-vtk
    fermiqcd.py -gauge:load=*.mdp -quark:kappa=0.12:alg=minres-vtk
    fermiqcd.py -gauge:load=*.mdp -quark:kappa=0.12 -pion
    fermiqcd.py -gauge:load=*.mdp -quark:kappa=0.12 -pion-vtk
"""
